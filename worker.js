...
// Check tabs on startup (tab reloading disabled to prevent breaking non-exam sites like neopass.fun)
chrome.tabs.query({}, async tabs => {
    // Disabled forced tab reloading to allow browsing neopass.fun and normal websites
});
